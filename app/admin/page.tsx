...
export default function DashboardPage() {
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="mt-4 rounded-xl border border-border bg-card text-card-foreground shadow-sm">
        <div className="flex flex-col space-y-1.5 p-6">
          <h3 className="font-semibold leading-none tracking-tight">Recent Activity</h3>
          <p className="text-sm text-muted-foreground">You have no recent activity.</p>
        </div>
        <div className="p-6 pt-0">
          <div className="flex items-center justify-center p-8 text-muted-foreground border-2 border-dashed border-border rounded-lg bg-muted/10">
            No bots created yet.
          </div>
        </div>
      </div>
